...
void main() {
  group('Test methods', () {
    test('operator ==', () {
      var constDateTime = ConstDateTime.fromMillisecondsSinceEpoch(0);
      ...
      constDateTime = ConstDateTime.fromMillisecondsSinceEpoch(0, isUtc: true);
      dateTime = DateTime.fromMillisecondsSinceEpoch(0, isUtc: true);
      expect(constDateTime == dateTime, isTrue);
      expect(dateTime == constDateTime, isTrue);

      constDateTime = ConstDateTime.fromMillisecondsSinceEpoch(0);
